...
class DkmKeyLogServiceImplTest {
    ...
    void testSelectForPage() {
        ...
        // Run the test
        final PageResp result = dkmKeyLogServiceImplUnderTest.selectForPage(0, 0, "vin", "userId", "startTime",
                "endTime", "phoneBrand", "phoneModel", Arrays.asList("value"), 0, "vehicleBrand", "vehicleModel",
                "vehicleType");
