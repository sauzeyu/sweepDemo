...
import com.vecentek.back.service.impl.DkmKey1ServiceImpl;
...
@Validated
@RestController
@RequestMapping("/dkmKey1")
public class DkmKey1Controller {
    /**
     * 服务对象
     */
    @Resource
    private DkmKey1ServiceImpl dkmKeyServiceImpl;
